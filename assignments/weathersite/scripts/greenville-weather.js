...
weatherObject.open('GET', 'https://api.wunderground.com/api/ea1dcb2430b970d7/conditions/q/TX/Greenville.json', true);
weatherObject.send();
...
forecastObject.open('GET', 'https://api.wunderground.com/api/ea1dcb2430b970d7/forecast/q/TX/Greenville.json', true);
forecastObject.send();
